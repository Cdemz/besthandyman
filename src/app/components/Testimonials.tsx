...
const data = [
  {
    ...
    name: "John D",
    reveiw:
      "Working with Best Handyman LLC was an absolute pleasure. Their team's attention to detail and commitment to delivering high-quality results exceeded our expectations. They were professional, reliable, and completed the project on time. Highly recommend!",
  },
...

  {
    ...
    reveiw:
      "We engaged Best Handyman LLC for a major renovation, and they truly transformed our property. Their team's expertise, project management skills, and clear communication made the entire process stress-free. The quality of their workmanship and their dedication to client satisfaction are commendable. We are grateful for their outstanding service.",
  },
];
