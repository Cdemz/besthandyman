    ...
    <div>
      <main className="p-4 mt-[4rem]">
        <h1 className="text-2xl font-semibold">
          Enhancing your construction project with Best Handyman LLC.
        </h1>
        <p>
          ...
          discover how Best Handyman LLC can bring your construction project to
          the next level.
        </p>
        <div className=""></div>
      </main>
      ...
      <section className="flex">
        <div className="p-4 flex flex-col gap-3">
          ...
          <p className="text-xs">
            ...
            besthandymanllc@gmail.com.
          </p>
        </div>
        <div className="hidden md:flex md:w-[40%]">
          <Image src="/services.png" alt="" width={300} height={300} />
        </div>
      </section>
      {/* copy copy  */}
      ...
      <div className="py-[4em] bg-black text-white px-4 text-xs font-bold text-center md:text-2xl">
        <h1 className="">
          When Construction Excellence Matters... Best Handyman LLC!
        </h1>
      </div>
    </div>
  );
